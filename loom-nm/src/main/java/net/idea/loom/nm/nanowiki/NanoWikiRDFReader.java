...
class ProcessMeasurement extends ProcessSolution {
	...
	ProcessSolution.execQuery(rdf, String.format(m_condition, measurement.getURI()), new ProcessCondition(effect));
...
class ProcessMaterial extends ProcessSolution {
	...
	execQuery(rdf, String.format(m_sparql, material.asResource().getURI()), new ProcessMeasurement(rdf, record));
    }
