...
public class BucketCallback implements ICallBack<String, QuerySolution> {
    ...
    protected String[] header = new String[] { "Has_Smiles", "Has_InChI", "Has_InChIKey", "Has_SigmaAldrich_Id",
	    "Has_DrugBank_Id", "Has_Leadscope_Id", "Has_ChemSpider_Id", "Has_ChEBI_Id", "Has_KEGG_Id", "Has_CAS",
	    "Has_ChEMBL_Id", "Has_PubChem_CID", "Has_Open-2DTG-2DGate_Id", "Accepted_by_ToxCast", "Has_category",
	    "Has_toxic_effect", "Has_target", "Has_Toxicity_List", "Has_pKa" };
