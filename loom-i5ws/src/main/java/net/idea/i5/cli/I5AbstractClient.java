...
public abstract class I5AbstractClient extends AbstractClient<String, IIdentifiableResource<String>> {
	...
	Fault, Code, Reason, Detail, DocumentFault, SessionFault, errorMessage
    }
    ...
    protected List<IIdentifiableResource<String>> processFault(InputStream in, String mediaType) throws RestException,
	    IOException {
    ...
    @Override
    protected List<IIdentifiableResource<String>> get(String identifier, String mediaType, String... params)
