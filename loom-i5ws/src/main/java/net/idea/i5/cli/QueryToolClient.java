...
public class QueryToolClient extends I5AbstractClient {
    ...
    public List<IIdentifiableResource<String>> executeQuery(PredefinedQuery queryID, String... params)
	    throws RestException, IOException {
	return getByIdentifier(queryID.name(), "ExecuteQuery", params);
    }

    public List<IIdentifiableResource<String>> countQuery(PredefinedQuery queryID, String... params)
	    throws RestException, IOException {
	return getByIdentifier(queryID.name(), "CountQuery", params);
    }

    @Override
    protected List<IIdentifiableResource<String>> getByIdentifier(String queryID, String queryType, String... params)
	    throws RestException, IOException {
