...
public class PubChemRESTClient<T extends IIdentifiableResource<String>> extends
		AbstractClient<String, T> {
	...
	protected List<T> get(String url, String mediaType, ICallback<List<T>> callback, String... params) throws RestException, IOException {
		String address;
		try {
