...
public abstract class AbstractOPSClient<T extends IIdentifiableResource<URL>> extends AbstractURIClient<T, String> {
    ...
    public T put(T object, java.util.List<String> accessRights) throws Exception {
	throw new NotSupportedMethodException();
    };

    public net.idea.opentox.cli.task.RemoteTask putAsync(T object) throws Exception {
	throw new NotSupportedMethodException();
    };
    ...
    @Override
    public T post(T object, URL collection, java.util.List<String> accessRights) throws Exception {
	throw new NotSupportedMethodException();
    };
    ...
    protected Integer getCount(String field, URL url, String mediaType, String... params) throws RestException,
	    IOException {
    ...
    protected Integer parseCount(InputStream in, String mediaType, String field) throws RestException, IOException {
