...
public class OPSPathwayClientTest extends
		AbstractOPSClientTest<Pathway, OPSPathwayClient> {
	...
	public void testPathwayByCompoundCount() throws Exception {
		Compound cmp = new Compound(
				new Identifier(
						"http://www.conceptwiki.org/concept/5d814567-347f-49f7-88cf-4ae4fe035690"));
		OPSPathwayClient cli = getOPSClient();
		Integer count = cli.getPathwaysByCompoundCount(new URL(TEST_SERVER),
				cmp);
